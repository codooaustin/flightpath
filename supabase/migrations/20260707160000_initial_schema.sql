...
JOIN (VALUES
  ...
  -- Student Aviator
  (2, 'Obtain Student Pilot Certificate', 'Apply for your student pilot certificate through IACRA.', 'Required before solo flight and formal training progression.', ARRAY['Create IACRA account', 'Submit application', 'Receive certificate'], 0.00, '1-2 weeks', 1),
  (2, 'Pass FAA Medical Exam', 'Complete your medical examination with an AME.', 'A valid medical certificate is required to exercise pilot privileges.', ARRAY['Schedule AME appointment', 'Bring required documents', 'Receive medical certificate'], 150.00, '1 day', 2),
  (2, 'Begin Ground School', 'Start studying aerodynamics, weather, regulations, and navigation.', 'Ground knowledge is essential for safe flying and written exams.', ARRAY['Enroll in course', 'Complete first module', 'Take practice tests'], 300.00, '4-8 weeks', 3),
  -- Student Pilot
